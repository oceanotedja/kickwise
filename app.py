...
MANUAL_RESULTS = [
    ...
    ("Canada", "Morocco", 0, 3, "2026-07-04"),  # Group B
    ("Paraguay", "France", 0, 1, "2026-07-04"),  # Group D
    ("Brazil", "Norway", 1, 2, "2026-07-05"),  # Group C
    ("Mexico", "England", 2, 3, "2026-07-06"),  # Group A
    ("Portugal", "Spain", 0, 1, "2026-07-06"),  # Group K
    ("United States", "Belgium", 1, 4, "2026-07-07"),  # Group D
    ("Argentina", "Egypt", 3, 2, "2026-07-07"),  # Group J
    ("Switzerland", "Colombia", 0, 0, "2026-07-07"),  # Group B
    ("France", "Morocco", 2, 0, "2026-07-09"),  # Group I
    ("Spain", "Belgium", 2, 1, "2026-07-10"),  # Group H
    ("Norway", "England", 1, 2, "2026-07-11"),  # Group I
    ("Argentina", "Switzerland", 3, 1, "2026-07-12"),  # Group J
